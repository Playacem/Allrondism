...
public class BlockPlantRose extends BlockFlower {
    ...
    public boolean canThisPlantGrowOnThisBlockID(int id) {
        ...
        return id == Block.grass.blockID || id == Block.dirt.blockID || id == Block.tilledField.blockID
                || id == ModBlocks.storageBlock.blockID;
    }
    ...
    private void checkRoseChange(World world, int x, int y, int z) {
        ...
        if (this.canBlockStay(world, x, y, z)) {
            ...
            if (oldMetadata != newMetadata) {
                 ...
                 * to clients (you almost always want this). Flag 4 prevents the
                 * block from being re-rendered, if this is a client world.
     ...
     * (examples: signs, buttons, stairs, flowers, etc)
     */
    @Override
    ...
    /**
     * Returns the collision box. Returning null means no collision box ==> You
     * can walk through this block.
     */
    @Override
